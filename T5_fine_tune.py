...
def fine_tune(training_path, validation_path, output_dir):
    ...
    model = T5ForConditionalGeneration.from_pretrained(model_name, torch_dtype=torch.bfloat16 if torch.cuda.is_bf16_supported() else torch.float16, device_map="auto")
    ...
    def preprocess_function(examples):
        ...
        targets = tokenizer(
            examples["summary"], max_length=300, truncation=True, padding="max_length"
        )
