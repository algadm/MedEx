...
from dashboard_utilities import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--summary_folder", type=str, default="summaries/", help="Folder containing patient summaries")
    parser.add_argument("--output_csv", type=str, default="patient_data.csv", help="Filename to save processed data as CSV")
    args = parser.parse_args()
    
    summaries = read_summaries(args.summary_folder)
